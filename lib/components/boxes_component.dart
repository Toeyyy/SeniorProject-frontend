...
class DottedListView extends StatelessWidget {
  ...
  const DottedListView({super.key, required this.showList});
...
class StatBarGraph extends StatelessWidget {
  final Map<String, int> statList;
  final String title;

  const StatBarGraph({super.key, required this.statList, required this.title});
