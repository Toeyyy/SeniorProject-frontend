  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SplitScreenNisit(
          ...
          rightPart: RightPartTreatmentDetail(
            topic: topic,
            questionObj: questionObj,
          )),
    );
...
class RightPartTreatmentDetail extends StatefulWidget {
  final String topic;
  QuestionObject questionObj;

  RightPartTreatmentDetail(
      {super.key, required this.topic, required this.questionObj});

  @override
  State<RightPartTreatmentDetail> createState() =>
      _RightPartTreatmentDetailState();
}

class _RightPartTreatmentDetailState extends State<RightPartTreatmentDetail> {
