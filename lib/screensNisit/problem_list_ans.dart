...
import 'package:frontend/screensNisit/diff_diag.dart';
import 'package:frontend/screensNisit/ten_diag.dart';
...
class ProbListAns extends StatelessWidget {
  ...
  const ProbListAns(
      {super.key, required this.questionObj, required this.round});
