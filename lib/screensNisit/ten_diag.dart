...
class TentativeDiag extends StatelessWidget {
  ...
  const TentativeDiag({super.key, required this.questionObj});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SplitScreenNisit(
        ...
        rightPart: RightPartTenDiagnosis(
          questionObj: questionObj,
        ),
      ),
    );
...
class RightPartTenDiagnosis extends StatefulWidget {
  QuestionObject questionObj;

  RightPartTenDiagnosis({super.key, required this.questionObj});

  @override
  State<RightPartTenDiagnosis> createState() => _RightPartTenDiagnosisState();
}

class _RightPartTenDiagnosisState extends State<RightPartTenDiagnosis> {
