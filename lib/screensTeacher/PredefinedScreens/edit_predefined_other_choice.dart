...
import 'package:frontend/screensTeacher/PredefinedScreens/edit_predefined_other_add.dart';
import 'package:frontend/screensTeacher/PredefinedScreens/edit_predefined_other_edit.dart';

class EditOtherInit extends StatefulWidget {
  final String title;
  const EditOtherInit({super.key, required this.title});
